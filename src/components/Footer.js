  ...
  return (
    <div className="container is-narrow">
      ...
      <div className="row social-icons">
        <p className="fields is-centered">
          <a
            className="icons mx-2"
            href="https://www.instagram.com/sarfaraz0011/"
            target="_blank"
            rel="noreferrer"
          >
            <svg
          ...
          <a
            className="icons mx-2"
            href="https://www.linkedin.com/in/mohammed-s-9096b1111/"
            target="_blank"
            rel="noreferrer"
          >
            <svg
          ...
          <a
            className="icons mx-2"
            href="https://www.facebook.com/sarfaraz.mohammed.73"
            target="_blank"
            rel="noreferrer"
          >
            <svg
          ...
          <a className="icons mx-2" href="mailto:sarfarazmohammed187@gmail.com">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="18"
              height="18"
